                                    ...
                                    <div class="card">
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mt-2">
                                                        <img id="showImage"
                                                            ...
                                                            alt="Room Image" class="rounded-1 bg-primary" width="80" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <label for="input2" class="form-label">Room Capasity</label>
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <select name="facility_name[]" id="facility_name"
                                                                        ...
                                                                        <option value="Complimentary Breakfast" {{
                                                                            $item->facility_name == 'Complimentary
                                                                            Breakfast' ? 'selected' : '' }}>
